...
export const SVGWorldMap = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 50" fill="currentColor" className={className}>
    <path d="M19.6 12.8c-1.2-.6-2.5.4-3.3 1.2-1.2 1.2-.8 3.5-1.5 5-.6 1.2-2.3 1.5-3 2.5-.5.8.2 2.2.8 3 .5.6 1.5.5 2 1 .5.5.2 1.5.5 2 1 .5.5.2 1.5.5 2 1 .5.5.2 1.5.5 2 .5 1.2 2.2 1 3.2 1.2 1.2.2 2.2 1.2 3.5 1.2 1.2 0 2.2-1 3-1.8.8-.8 1.2-2 2-2.8.8-.8 2-1 3-1.5 1-.5 2.5-.2 3.5-1 1-.8.5-2.2 0-3.2-.5-1-1.5-1.5-2-2.5-.5-1 .2-2.2-.2-3.2-.5-1-1.8-1.5-2.8-1.5-1 0-2 .8-2.8.5-.8-.2-1.2-1.2-2-1.5-.8-.2-1.8-.2-2.5-.5-.8-.2-1.2-1-1.5-1.8-.2-.8-.2-1.8-.5-2.5zm45 2.5c-1.5 1-2.5 2.5-3.5 4-.8 1.2-1.2 2.8-2 4-.8 1.2-2 2-3 2.5-1 .5-2.2.2-3.2.5-1 .2-1.8 1-2.5 1.8-.8.8-1.2 2-1.5 3-.2 1 .2 2.2.8 3 .5.8 1.5 1.2 2.5 1.5 1 .2 2.2-.2 3 .2.8.5 1.2 1.5 2 2 .8.5 2 .2 2.8.5.8.2 1.5 1 2.2 1.2 1 .2 2.2-.5 3-.8.8-.2 1.5-1 2-1.8.5-.8.5-1.8 1-2.5.5-.8 1.5-1 2.2-1.5 1-.5 2.5-.8 3.5-1.2 1-.5 1.8-1.5 2.2-2.5.5-1 .2-2.2-.2-3.2-.5-1-1.5-1.5-2.2-2.2-.8-.8-1.2-1.8-1.8-2.8-.5-1-1-2-1.5-3-.5-1-1.5-1.5-2.2-2-.8-.5-1.8-.5-2.8-.8-1-.2-2-.5-2.8-1-.8-.5-1.2-1.5-1.8-2.2-.5-.8-1-1.5-1.8-1.8z" opacity="0.4"/>
  </svg>
);
