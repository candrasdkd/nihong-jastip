...
export function LedgerFormModal({
  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        className="relative w-full md:w-[560px] max-w-full md:max-w-[90vw] rounded-t-2xl md:rounded-2xl bg-white shadow-xl ring-1 ring-[#0a2342]/10 h-[92vh] md:h-auto max-h-[92vh] flex flex-col"
      >
        {/* Header */}
            ...
            {isMonthlyProfitCategory ? (
              <div className="md:col-span-2 p-3 border border-orange-200 rounded-lg bg-orange-50 space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full bg-white border-orange-500 text-orange-800 hover:bg-orange-100"
                >
                  {isCalculating
                    ? "Menghitung..."
                    : "Hitung & Ambil Keuntungan"}
                </Button>
              </div>
            ) : null}
            ...
            <div className="md:col-span-2">
              ...
              {isMonthlyProfitCategory && (
                <p className="text-xs text-slate-500 mt-1">
                  Keterangan diisi otomatis dari hasil kalkulasi.
                </p>
              )}
            </div>
