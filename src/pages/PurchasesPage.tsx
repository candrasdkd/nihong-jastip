  ...
  return (
    ...
    >
        ...
        <div className="sticky top-2 z-30 bg-white/80 backdrop-blur-md p-1.5 rounded-2xl shadow-sm border border-slate-200/60 flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1 group">
            ...
            <input
              type="text"
              placeholder="Cari..."
              // FIX ZOOM: text-base sm:text-xs
              className="w-full pl-9 pr-4 py-2 bg-transparent text-base sm:text-xs outline-none font-medium placeholder:text-slate-400"
              value={searchQuery}
      ...
      <motion.button
        ...
        className="fixed bottom-20 right-5 sm:bottom-10 sm:right-10 w-10 h-10 sm:w-14 sm:h-14 bg-orange-600 text-white rounded-2xl shadow-2xl flex items-center justify-center z-40 border-4 border-white/20 active:bg-orange-700 shadow-orange-900/20"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          // MODAL WRAPPER: items-end untuk mobile (bottom sheet), sm:items-center untuk desktop
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
            ...
            <motion.div
              ...
              // MODAL BOX: h-[92dvh] untuk mobile (anti address bar tertutup), sm:h-[85vh] untuk desktop
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row flex-1 min-h-0 overflow-hidden">
                ...
                <div className={`w-full sm:w-1/2 flex flex-col h-full relative ${!editing && activeTab === "draft" ? "hidden sm:flex" : "flex"}`}>
                  ...
                  <div className="flex-1 overflow-y-auto p-5 custom-scrollbar pb-20 sm:pb-80">
                    <div className="space-y-4">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          // FIX ZOOM: text-base sm:text-xs
                          className="w-full bg-white border border-slate-200 p-3 rounded-xl text-base sm:text-xs outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 font-bold transition-all placeholder:font-normal placeholder:text-slate-300 shadow-sm"
                          value={form.name}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <input type="date" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 font-bold shadow-sm" value={form.shippingDate} onChange={(e) => setForm({ ...form, shippingDate: e.target.value })} />
                        </div>
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide ml-1">Jumlah</label>
                          <input placeholder="1 pcs" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 font-bold shadow-sm" value={form.quantity} onChange={(e) => setForm({ ...form, quantity: e.target.value })} />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input placeholder="Nama Pembeli..." className="w-full bg-white border border-slate-200 pl-9 pr-3 py-3 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 font-bold shadow-sm" value={form.customer} onChange={(e) => setForm({ ...form, customer: e.target.value })} />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <div className="relative">
                            <select
                              className="w-full bg-white border border-slate-200 p-3 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 appearance-none font-bold shadow-sm cursor-pointer"
                              value={form.pic}
                      ...
                      <div className="pt-1">
                        <details className="group">
                          ...
                          <div className="space-y-3 pt-3 animate-in slide-in-from-top-2 duration-300">
                            <input placeholder="Link Produk" className="w-full bg-white border border-slate-200 p-2.5 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 font-medium" value={form.link} onChange={(e) => setForm({ ...form, link: e.target.value })} />
                            <textarea placeholder="Catatan..." rows={2} className="w-full bg-white border border-slate-200 p-2.5 rounded-xl text-base sm:text-xs outline-none focus:border-orange-500 resize-none font-medium" value={form.note} onChange={(e) => setForm({ ...form, note: e.target.value })} />
                          </div>
                        </details>
                      </div>
                ...
                <div className={`w-full sm:w-1/2 flex flex-col h-full p-5 bg-white sm:border-l border-slate-100 ${!editing && activeTab === "input" ? "hidden sm:flex" : "flex"}`}>
                  ...
                  <div className="flex-1 overflow-y-auto space-y-2 mb-4 pr-1 custom-scrollbar pb-20 sm:pb-0">
